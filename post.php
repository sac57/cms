    ...
    <?php  } 
          ?>  <?php
                if(isset($_POST['create_comment'])){
                    ...
                    $comment_con = mysqli_query($connection,$comment_query);
                    if(!$comment_con){
                        die('failed'.mysqli_error($connection));
                    }
                    $update_query= "UPDATE posts SET post_comment_count=post_comment_count + 1 ";
                    $update_query .= "WHERE post_id=$post_id";
                    $up=mysqli_query($connection,$update_query);
                }
                ?>  
            ...
            while($row=mysqli_fetch_array($select_com)){
